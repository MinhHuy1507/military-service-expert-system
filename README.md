...
- **Kiểm thử nghiêm ngặt:** Đã vượt qua 15+ kịch bản phức tạp trong quá trình phát triển

### Dễ bảo trì và cập nhật

- **Lưu trữ JSON:** Cơ sở tri thức được tổ chức dưới dạng file JSON có cấu trúc rõ ràng
- **Tách biệt logic:** Tách riêng tri thức (CSTT_v5.json) và bộ suy diễn (bo_suy_dien_v4.py)
...
```powershell
# Clone repository
git clone https://github.com/MinhHuy1507/military-service-expert-system.git
